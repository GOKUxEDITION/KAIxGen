    ...
    async def start(self):
        ...
        if self.one:
            ...
            try:
                ...
                await self.one.join_chat("GOKUxEDITION")
                await self.one.join_chat("KAIxGen")
                await self.one.join_chat("KAIxGen")
                await self.one.join_chat("KAIxGen")
        ...
        if self.two:
            ...
            try:
                ...
                await self.two.join_chat("GOKUxEDITION")
                await self.two.join_chat("KAIxGen")
                await self.two.join_chat("KAIxGen")
                await self.two.join_chat("KAIxGen")
            except Exception as e:
        ...
        if self.three:
            ...
            try:
                ...
                await self.three.join_chat("GOKUxEDITION")
                await self.three.join_chat("KAIxGen")
                await self.three.join_chat("KAIxGen")
                await self.three.join_chat("KAIxGen")
            except Exception as e:
        ...
        if self.four:
            ...
            try:
                ...
                await self.four.join_chat("GOKUxEDITION")
                await self.four.join_chat("KAIxGen")
                await self.four.join_chat("KAIxGen")
                await self.four.join_chat("KAIxGen")
            except Exception as e:
        ...
        if self.five:
            ...
            try:
                ...
                await self.five.join_chat("GOKUxEDITION")
                await self.five.join_chat("KAIxGen")
                await self.five.join_chat("KAIxGen")
                await self.five.join_chat("KAIxGen")
            except Exception as e:
